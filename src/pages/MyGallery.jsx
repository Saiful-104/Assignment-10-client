      ...
      <div className="max-w-6xl mx-auto">
        ...
        {artworks.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mt-2">Start adding your artworks to build your gallery!</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {artworks.map(art => (
              <div key={art._id} className="bg-white rounded-xl shadow overflow-hidden hover:shadow-lg transition">
                <img 
                  src={art.imageUrl} 
                  alt={art.title} 
                ...
                />
                <div className="p-4">
                  <h3 className="text-lg font-semibold text-gray-700 truncate">{art.title}</h3>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white text-orange-950 rounded-2xl max-w-md w-full p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Are you sure you want to delete "<strong>{selectedArtwork.title}</strong>"? 
